...
import com.example.ppcare.Adapter.epidInfoListAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewPager.setPageTransformer(object : ViewPager2.PageTransformer {
            override fun transformPage(page: View, position: Float) {
                ...
                // position: -1  0  1
//                val bac=page.findViewById<View>(R.id.blur_bac)
...
//                }
        ...
        newsText.setOnClickListener {
            articleDialog(this@epidemic_info,this@epidemic_info,1).show()
        }
        var cardView= arrayOf(dot1,dot2,dot3,dot4,dot5)
        newsText.text =sqlEpid.getTitle(this@epidemic_info,this@epidemic_info,1)
        ...
        viewPager.registerOnPageChangeCallback(object : ViewPager2.OnPageChangeCallback(){
            override fun onPageSelected(position: Int) {
                ...
                try {
                    newsText.text =sqlEpid.getTitle(this@epidemic_info,this@epidemic_info,curPos)
                    CustomEllipsize(newsText, 2, "......more>>")
                    newsText.setOnClickListener {
                        articleDialog(this@epidemic_info,this@epidemic_info,curPos).show()
                    }
                }catch (ex: Exception){}
            }
        })
        ...
        list.adapter=epidInfoListAdapter(this,this)
        ...
        tv.viewTreeObserver.addOnGlobalLayoutListener(object : OnGlobalLayoutListener {
            override fun onGlobalLayout() {
                try{
                    ...
                    if(index!=tv.layout.getLineEnd(maxLine-2)-(ellipsizetext.length/1.7).toInt()){
                        var text=tv.text.substring(0,index)+ellipsizetext
                        tv.text=text
                    }
                    else{
                        tv.text=tv.text.toString()+ellipsizetext
                    }
